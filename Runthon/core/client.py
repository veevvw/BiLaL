            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع رنثون 𝐑𝐔𝐍𝐓𝐇𝐎𝐍--------"
                        ...
                        link = "[𝐑𝐔𝐍𝐓𝐇𝐎𝐍](https://t.me/BxxBxxL)"
                        text = (
                            "**✘ تقـريـر إشعـار تيبثـون 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار رنثون 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 ✘**\n\n "
                        link = "[𝐑𝐔𝐍𝐓𝐇𝐎𝐍](https://t.me/BxxBxxL)"
